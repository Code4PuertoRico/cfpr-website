  ...
  return (
    <main>
      ...
      <div className="container mt-5">
        <h1 className="text-primary">Sobre Nosotros</h1>
        <div>
          <h2 className="text-secondary my-4">Misión y Visión</h2>
          ...
          <div className="py-1">
            ...
            <ul>
              <li><a href="https://docs.google.com/document/d/e/2PACX-1vQSsyGkzxEkB8UNZIV6s_GHw_dUgxwZUwyFIGqIZxGGHZn5Euwdi-lijXZ-ZOUS_DDISLlTF1PdfWzR/pub">Quiénes somos y nuestra misión</a></li>
              <li><a href="https://docs.google.com/document/d/e/2PACX-1vST7-Sn6hx9_Tu_ZDSzmSZws2PWGj7Tox9MBvdTyvcumDqgM9Cf1Zl-KZGm1PHacWzaWvNV0MbbnLXE/pub">Nuestros valores - Español</a></li>
              <li><a href="https://docs.google.com/document/d/e/2PACX-1vTsKOZKGnmTPnGdxIFmlENpaWs_472wtvvHet9N91xm0xbvmBfwP9VtSDFK7uOo_KS8lqi0cy4lQMj8/pub">Nuestros valores - Inglés</a></li>
            </ul>
          </div>
          <h2 className="text-secondary my-4">Una Brigada de Code for America</h2>
          ...
          <h2 className="text-secondary my-4">Nuestro Equipo</h2>
          ...
          <ul>
           ...
           <h2 className="my-4 text-secondary">Código de Conducta</h2>
            ...
            <h2 className="my-4 text-secondary">Requisitos para proyectos</h2>
