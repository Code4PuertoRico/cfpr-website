  ...
  return (
    <main>
      ...
      <div className="container pt-12 md:pt-24 px-6 mx-auto flex flex-wrap flex-col md:flex-row">
        <h1 className="my-4 text-3xl md:text-5xl text-blue-400 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">Sobre Nosotros</h1>
        <div>
          <h2 className="my-4 text-blue-400 text-xl font-bold slide-in-bottom-h2">Misión y Visión</h2>
          ...
          <h2 className="my-4 text-blue-400 text-xl font-bold slide-in-bottom-h2">Una Brigada de Code for America</h2>
          ...
          <h2 className="my-4 text-blue-400 text-xl font-bold slide-in-bottom-h2">Nuestro Equipo</h2>
          ...
          <ul className="list-disc list-inside">
           ...
           <h2 className="my-4 text-blue-400 text-xl font-bold slide-in-bottom-h2">Código de Conducta</h2>
            ...
            <h2 className="my-4 text-blue-400 text-xl font-bold slide-in-bottom-h2">Requisitos para proyectos</h2>
            <ul className="list-disc list-inside">
