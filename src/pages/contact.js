    ...
    return (
        <div>
            ...
            <div className="container pt-12 md:pt-24 px-6 mx-auto flex flex-wrap flex-col md:flex-row">
                ...
                <div>
                    <h2 className="my-2 text-blue-400 text-xl font-bold slide-in-bottom-h2">Slack</h2>
                    ...
                    <div className="flex w-full justify-center md:justify-start pb-8 lg:pb-0 fade-in mt-2">
                ...
                <div className="mt-2">
                    <h2 className="my-2 text-blue-400 text-xl font-bold slide-in-bottom-h2">Redes Sociales</h2>
